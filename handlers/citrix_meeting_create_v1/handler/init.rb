...
class CitrixMeetingCreateV1
  ...
  def execute()
    ...
    response = JSON.parse(RestClient.post(url,post_json,:content_type=>'application/json',:accept=>'application/json','Authorization'=>token))
